...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'buscar_telefono') {
        ...
        if ($telefonoBuscado === '') {
            ...
            redirect('/tienda-de-barrio/seguimiento.php');
        }
...
<div class="table-card p-3 p-md-4 mx-auto" style="max-width: 700px;">
                        ...
                        <?php foreach ($pedidosPorTelefono as $p): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary btn-sm" href="/tienda-de-barrio/seguimiento.php?id=<?= (int) $p['id'] ?>&telefono=<?= urlencode($telefonoBuscado) ?>">Ver detalle</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
    ...
    <?php if ($pedido): ?>
        ...
        <div class="border-top pt-3">
            ...
            <div class="mt-3">
                <a href="/tienda-de-barrio/seguimiento.php" class="btn btn-outline-primary">Buscar otro pedido</a>
